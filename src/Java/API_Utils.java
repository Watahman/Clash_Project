...
public class API_Utils {
    ...
    public API_Utils(Config conf) {
        ...
        this.clashApiClient = new ClashApiClient(
                conf.getClashApiKeyPool(),
                conf.getClashApiRateLimitCooldownMillis(),
                conf.getClashApiMaximumCooldownMillis()
        );
    }
