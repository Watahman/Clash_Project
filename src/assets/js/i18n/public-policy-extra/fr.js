...
export default Object.freeze({
    ...
    privacy: Object.freeze({
        ...
        sections: Object.freeze([
            ...
            ['Fournisseurs et partage des données', [
                ...
                'Les fournisseurs d’infrastructure et d’application peuvent inclure Supabase pour l’authentification et les données d’application, Google Cloud pour l’hébergement du backend, Cloudflare pour la livraison et la sécurité du site, Google pour la connexion, les polices ou la publicité, Infolinks pour la publicité sur certaines pages publiques éligibles, les services Supercell pour les données actuelles de l’API Clash of Clans et ClashKing V2 pour les demandes Advanced Stats historiques.',
            ...
            ['Publicité Google et Infolinks', [
                ...
                'Infolinks peut traiter des données techniques et des cookies en lien avec ses services publicitaires. Consultez sa politique de confidentialité dans le lien ci-dessous.',
                ...
                'Pour les visiteurs de l’EEE, du Royaume-Uni et de la Suisse, le consentement publicitaire est géré selon les choix présentés par la solution de gestion du consentement configurée et les exigences applicables au fournisseur concerné. Infolinks n’est pas chargé lorsque le consentement publicitaire requis est indisponible ou refusé.'
            ]],
        ...
        links: Object.freeze([
            ...
            ['Politique de confidentialité Infolinks', 'https://sites0001.infolinks.com/privacy-policy']
        ])
    }),
    cookies: Object.freeze({
        ...
        summary: 'ClashPanel utilise des technologies de navigateur essentielles au service et peut utiliser des technologies publicitaires Google et Infolinks sur les pages où les annonces sont activées.',
        sections: Object.freeze([
            ['Champ d’application', [
            ...
            ['Google, Infolinks et technologies publicitaires', [
                ...
                'Google fournit des informations sur l’utilisation des données provenant de sites partenaires et des paramètres permettant de contrôler la publicité personnalisée. Infolinks fournit sa propre politique de confidentialité pour ses services publicitaires.'
            ]],
    ...
    terms: Object.freeze({
        ...
        sections: Object.freeze([
            ...
            ['Publicité et services externes', [
                'ClashPanel peut afficher des publicités tierces, dont Google AdSense ou Infolinks, uniquement sur certaines pages publiques éligibles et après le consentement publicitaire requis lorsque celui-ci s’applique. Une publicité ne signifie pas que ClashPanel approuve l’annonceur, le produit ou le site externe.',
    ...
    contact: Object.freeze({
        ...
        sections: Object.freeze([
            ['Assistance par e-mail', [
                `Pour les bugs, demandes de fonctions, questions de compte, demandes de confidentialité, questions AdSense, Infolinks ou publicitaires et demandes générales, écrivez à ${SUPPORT_EMAIL}.`,
