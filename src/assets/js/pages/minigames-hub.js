...
const COPY = {
    en: {
        ...
        policy: 'This material is unofficial and is not endorsed by Supercell. Game images are stored locally as recognition clues for this fan-made quiz. See Supercell\'s Fan Content Policy for more information.', ready: 'Ready to play', inProgress: 'In progress', solved: 'Solved', complete: 'Complete', playNow: 'Play now', storageNote: 'Your progress stays on this device.'
    },
    nl: {
        ...
        ready: 'Klaar om te spelen', inProgress: 'Bezig', solved: 'Opgelost', complete: 'Voltooid', playNow: 'Nu spelen', storageNote: 'Je voortgang blijft op dit apparaat.'
    },
    de: {
        ...
        ready: 'Bereit zum Spielen', inProgress: 'In Bearbeitung', solved: 'Gelöst', complete: 'Abgeschlossen', playNow: 'Jetzt spielen', storageNote: 'Dein Fortschritt bleibt auf diesem Gerät.'
    },
    fr: {
        ...
        ready: 'Prêt à jouer', inProgress: 'En cours', solved: 'Résolu', complete: 'Terminé', playNow: 'Jouer maintenant', storageNote: 'Votre progression reste sur cet appareil.'
    },
    es: {
        ...
        ready: 'Listo para jugar', inProgress: 'En curso', solved: 'Resuelto', complete: 'Completado', playNow: 'Jugar ahora', storageNote: 'Tu progreso permanece en este dispositivo.'
    }
};
...
function renderHub() {
    ...
    if (summary) {
        summary.textContent = `${text('entity')}: ${entityStatus(dateKey)} · ${text('higherLower')}: ${higherLowerStatus(dateKey)} · ${text('sceneryScout')}: ${sceneryScoutStatus(dateKey)}. ${text('storageNote')}`;
    }
