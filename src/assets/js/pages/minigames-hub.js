...
const COPY = {
    en: {
        ...
        ready: 'Ready to play', inProgress: 'In progress', solved: 'Solved', complete: 'Complete', playNow: 'Play now', storageNote: 'Your progress stays on this device.'
    },
    nl: {
...
function renderHub() {
    ...
    if (summary) {
        summary.textContent = `${text('entity')}: ${entityStatus(dateKey)} · ${text('higherLower')}: ${higherLowerStatus(dateKey)}. ${text('storageNote')}`;
    }
