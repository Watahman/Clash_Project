        ...
        <div class="resource-layout">
            ...
            <div class="resource-content">
                <article class="resource-article" id="auto-plan">
                    ...
                    <figure class="sample-panel"><span class="sample-label">${t('methodology.sampleNotLive')}</span><table><thead><tr><th>${t('methodology.day')}</th><th>${t('methodology.coreAvailable')}</th><th>${t('methodology.rotationUsed')}</th><th>${t('methodology.warning')}</th></tr></thead><tbody><tr><td>1</td><td>13 / 13</td><td>Sample A, Sample B</td><td class="status-ok">${t('methodology.complete15')}</td></tr><tr><td>4</td><td>12 / 13</td><td>Sample C</td><td class="status-watch">${t('methodology.reserveNeeded')}</td></tr><tr><td>7</td><td>11 / 13</td><td>Sample A</td><td class="status-risk">${t('methodology.missingPlayer')}</td></tr></tbody></table><figcaption>${t('methodology.autoCaption')}</figcaption></figure>
