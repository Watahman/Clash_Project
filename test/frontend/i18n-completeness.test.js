...
const dashboardKeys = [
    ...
    'guidance.dashboard.achievementsTitle',
    'guidance.dashboard.achievementsText',
    'guidance.dashboard.achievementsAction',
...
const guideKeys = [
    ...
    'guidance.achievements.title',
    'guidance.achievements.intro',
    ...
    'guidance.advancedStats.title',
    'guidance.advancedStats.intro',
